...
const Add = (props) => {
    ...
    const onSubmit = async (data) => {
        ...
        let msg = (response.message)?response.message:'Inventory add successfully'
        setFields('');
        reset();
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="field">
                ...
                <Controller
                    ...
                    <Calendar className={classNames({ 'p-invalid': fieldState.error })} inputId={field.name} value={fields.purchase_date} onChange={(e) => { onSelectChange(e,'purchase_date'); field.onChange(e.value) }} dateFormat="dd/mm/yy"  />
                    }
                />
